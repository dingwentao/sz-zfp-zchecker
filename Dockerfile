...
RUN apk update && \
    apk add texlive texlive-dvi texmf-dist-latexextra gnuplot bash ghostscript gcc g++ cmake make git zlib-dev zstd-dev
...
RUN echo "http://dl-cdn.alpinelinux.org/alpine/edge/testing">>/etc/apk/repositories && \
    apk add --no-cache texlive texlive-dvi texmf-dist-latexextra gnuplot bash ghostscript gcc g++ cmake make git zlib-dev zstd-dev openssh openmpi-dev zip
